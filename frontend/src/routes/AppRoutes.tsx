...
function AppRoutes() {
    return (
        <Routes>
            ...
            <Route path="/corpus-explorer" element={<ProtectedRoute><CorpusExplorerPage /></ProtectedRoute>} />
            <Route path="/corpus-explorer/search" element={<ProtectedRoute><SearchPage /></ProtectedRoute>} />
            <Route path="/corpus-explorer/record/:id" element={<ProtectedRoute><RecordDetailsPage /></ProtectedRoute>} />
            <Route path="/corpus-explorer/languages" element={<ProtectedRoute><LanguagesPage /></ProtectedRoute>} />
            <Route path="/corpus-explorer/categories" element={<ProtectedRoute><CategoriesPage /></ProtectedRoute>} />
            <Route path="/corpus-explorer/profile" element={<ProtectedRoute><ProfilePage /></ProtectedRoute>} />

            <Route path="/sprintwise-ai" element={<ProtectedRoute><SprintPage /></ProtectedRoute>} />
            <Route path="/sprintwise-ai/projects" element={<ProtectedRoute><Projects /></ProtectedRoute>} />
            <Route path="/sprintwise-ai/team" element={<ProtectedRoute><Team /></ProtectedRoute>} />
            <Route path="/sprintwise-ai/generator" element={<ProtectedRoute><SprintGenerator /></ProtectedRoute>} />
            ...
            <Route path="/profile" element={<ProtectedRoute><ExistingProfilePage /></ProtectedRoute>} />
        </Routes>
    );
}
