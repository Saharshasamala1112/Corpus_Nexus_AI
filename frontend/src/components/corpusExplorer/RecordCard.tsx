    ...
    return (
        <article className="rounded-3xl border border-zinc-800 bg-zinc-950/70 p-5 shadow-lg shadow-black/20 transition hover:border-violet-500/40 hover:-translate-y-1">
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-xs text-zinc-300">
                <span className="rounded-full border border-violet-500/30 bg-violet-500/10 px-2.5 py-1">{record.language}</span>
                <span className="rounded-full border border-zinc-700 bg-zinc-900 px-2.5 py-1">{record.category}</span>
            </div>
