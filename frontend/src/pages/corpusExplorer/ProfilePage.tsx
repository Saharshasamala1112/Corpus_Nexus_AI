        ...
        <div className="space-y-6">
            <div className="rounded-3xl border border-zinc-800 bg-gradient-to-br from-zinc-900 via-zinc-950 to-zinc-900 p-6 shadow-lg shadow-black/20">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-zinc-400">Account identity and organisational metadata for Corpus Explorer.</p>
                    </div>
                </div>
            </div>
            ...
            <section className="grid gap-4 md:grid-cols-2">
                {profileItems.map((item) => {
                    ...
                    return (
                        <div key={item.label} className="rounded-3xl border border-zinc-800 bg-zinc-950/70 p-5 shadow-lg shadow-black/20">
                            <div className="flex items-center gap-3">
                                <div className="rounded-2xl border border-violet-500/30 bg-violet-500/10 p-2 text-violet-300">
