...
function Navbar({ onOpenMobile, collapsed }: NavbarProps) {
  ...
  return (
    <header
      className={`sticky top-0 z-20 flex h-[72px] items-center justify-between border-b border-zinc-800 bg-[#09090b]/95 px-4 backdrop-blur md:px-6 ${collapsed ? 'lg:pl-6' : 'lg:pl-6'}`}
    >
