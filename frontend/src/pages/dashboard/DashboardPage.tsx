...
const kpiCards = [
  ...
  },
  {
    ...
    value: '186',
    subtitle: '+9 active today',
    icon: Users,
    tone: 'border-sky-500/30 bg-sky-500/10 text-sky-300',
  },
  {
    label: 'Overall Corpus Health',
    value: '97.4%',
    subtitle: 'Stable and improving',
    icon: ShieldCheck,
...
const insights = [
  {
    ...
    description: 'Low variance detected in multilingual retrieval patterns.',
    time: '8 min ago',
    icon: BrainCircuit,
  },
  {
    title: 'Policy confidence',
    description: 'Guardrails are holding steady across 97% of active jobs.',
    time: '24 min ago',
    icon: Layers3,
  },
  {
    title: 'Operator overload',
    description: 'Three queues are approaching review capacity thresholds.',
    time: '41 min ago',
    icon: Activity,
  },
]
...
const recentIngestions = [
  ...
  {
    document: 'Product launch notes',
    language: 'German',
    operator: 'Sana Patel',
    status: 'Synced',
  },
  {
    document: 'Customer support logs',
    language: 'Japanese',
    operator: 'Noah Reed',
    status: 'Queued',
  },
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-base leading-7 text-zinc-400 sm:text-lg">
                Monitor knowledge health, automate insights, and stay ahead with a multi-surface AI
                workspace designed for enterprise execution.
              </p>
            </div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-4">
                ...
                <div className="mt-3 flex items-center gap-2 text-sm text-zinc-300">
                  <BrainCircuit className="h-4 w-4 text-violet-400" />8 tuned agents in active
                  rotation
                </div>
              </div>
            </div>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {kpiCards.map((card) => {
          ...
          return (
            <Card
              key={card.label}
              className="group border-zinc-800 bg-zinc-950/70 shadow-lg shadow-black/20 transition duration-200 hover:-translate-y-1 hover:border-violet-500/40"
            >
