...
function Tasks() {
  ...
  const completedCount = onboardingTasks.filter((task) => progress[task.id]?.completed).length

  return (
    <div className="onboarding-page">
      <h1>Intern Onboarding</h1>

      <ProgressCard totalTasks={onboardingTasks.length} completedTasks={completedCount} />
