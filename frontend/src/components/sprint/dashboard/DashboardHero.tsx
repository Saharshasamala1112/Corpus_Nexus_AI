      ...
      <div className="relative grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-slate-300 sm:text-base">
            Create your first project, invite your team, and generate AI-powered sprint plans.
            Everything you need to organize modern product development in one place.
          </p>
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-950/70 p-5 backdrop-blur">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-lg font-semibold text-white">Get Started</p>
            </div>
          ...
          <div className="mt-6 rounded-xl border border-dashed border-cyan-500/20 bg-cyan-500/5 p-4">
            <p className="text-sm font-medium text-cyan-300">Your workspace is ready</p>

            <p className="mt-1 text-sm text-slate-400">
              Create your first project to start planning AI-powered sprints and collaborating with
              your team.
            </p>
          </div>
        </div>
