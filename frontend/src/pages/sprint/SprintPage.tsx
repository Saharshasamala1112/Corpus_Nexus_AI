function SprintPage() {
    return (
        <div className="rounded-3xl border border-zinc-800 bg-zinc-950/70 p-10 shadow-2xl shadow-black/20">
            <p className="text-sm font-medium uppercase tracking-[0.35em] text-violet-400">SprintWise AI</p>
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-white">Sprint planning</h1>
