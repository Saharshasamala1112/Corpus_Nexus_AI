function CorpusInsightsPage() {
    return (
        <div className="rounded-3xl border border-zinc-800 bg-zinc-950/70 p-10 shadow-2xl shadow-black/20">
            <p className="text-sm font-medium uppercase tracking-[0.35em] text-violet-400">Corpus Insights</p>
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-white">Insights workspace</h1>
