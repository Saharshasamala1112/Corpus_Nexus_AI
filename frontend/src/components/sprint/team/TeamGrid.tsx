  ...
  return (
    <section className={cn('w-full', className)}>
      <div className="rounded-2xl border border-dashed border-white/10 bg-slate-950/70 p-10 text-center shadow-[0_0_0_1px_rgba(255,255,255,0.03)]">
        ...
        <h3 className="mt-6 text-2xl font-semibold text-white">No team members yet</h3>

        <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-slate-400">
          Invite your teammates to collaborate on projects, manage sprint planning together, and
          track progress across your workspace.
        </p>

        <Button className="mt-6" onClick={() => navigate('/sprintwise-ai/team')}>
          Invite Member
