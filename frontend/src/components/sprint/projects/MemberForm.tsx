...
export default function MemberForm({ onAddMember, editingMember, onCancelEdit }: MemberFormProps) {
  ...
  const [availability, setAvailability] = useState(editingMember?.availability ?? 40)
